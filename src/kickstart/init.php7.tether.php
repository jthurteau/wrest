 ...
 * 
 * init tether, binds a canister (array only) to core callables
...
return function (&$canister) {
     ...
     * fork pylon file
     */
    $registry['pylon'] = function(string $pylon, ?string $fail = null) use (&$canister) {
        $pylonFile = $canister['_f']($pylon, '.pylon');
        $genericFile = $canister['_f']($pylon);
